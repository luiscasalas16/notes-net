# notes-net / vs - Visual Studio

## Documentación

- [Oficial](https://learn.microsoft.com/en-us/visualstudio/ide)
...
- [CSharpier](https://marketplace.visualstudio.com/items?itemName=csharpier.CSharpier2019)
